...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#2c1a00] to-[#e6b85d] text-white lg:ml-64">
      <div className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
            ...
            <div className="lg:col-span-2 flex flex-col items-center md:items-start">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-center md:justify-start">
                  <Phone className="h-4 w-4 mr-3 text-orange-300" />
                  <span className="text-orange-100 font-medium">+91 98765 43210</span>
                </div>
                <div className="flex items-center justify-center md:justify-start">
                  <Mail className="h-4 w-4 mr-3 text-orange-300" />
                  <span className="text-orange-100 font-medium">support@e-snan.com</span>
                </div>
                <div className="flex items-center justify-center md:justify-start">
                  <MapPin className="h-4 w-4 mr-3 text-orange-300" />
              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      href={link.href}
                      className="text-orange-100 hover:text-white transition duration-200 hover:underline font-medium"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          {/* Sacred Quote */}
          <div className="text-center py-8 border-y border-orange-900 my-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 text-center">
            <div>
              ...
              <div className="flex justify-center space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="p-3 bg-orange-900 rounded-full hover:bg-orange-700 transition duration-200 transform hover:scale-110"
                  >
            ...
            <div>
              <div className="bg-green-800/40 rounded-lg p-4 backdrop-blur-sm border border-green-700/30 inline-block">
          ...
          {/* Bottom Bar */}
          <div className="mt-8 pt-8 border-t border-orange-700 text-center text-sm space-y-2 sm:space-y-0 sm:flex sm:justify-between sm:items-center">
            <p className="text-orange-900 font-medium">
              © 2024 e-Snan. All rights reserved. Made with ❤️ for spiritual devotees worldwide.
            </p>
            <p className="text-orange-900 font-medium">
